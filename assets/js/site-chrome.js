(function () {
  ...
  function renderSiteHeader() {
    ...
    root.innerHTML = [
      ...
      '        <span class="brand-lhs">',
      '          <img src="' + toSitePath("assets/images/tact-logo.png") + '" alt="tAcT logo" class="site-logo" loading="lazy" decoding="async">',
      '          <span class="brand-wordmark">The Academy Trust</span>',
      '        </span>',
      "      </a>",
      "    </div>",
  ...
  function renderSiteFooter() {
    ...
    root.innerHTML = [
      ...
      "        <img src=\"" + toSitePath("assets/images/tact-logo.png") + "\" alt=\"tAcT logo\" class=\"sfv2-brand-logo\" loading=\"lazy\" decoding=\"async\">",
